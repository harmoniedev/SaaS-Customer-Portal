...
export const DashboardScene = () =>
{
  ...
  const getData = async () =>
  {
    const domain = Object.keys(parseJWT((token)))[2];
    ...
    email_domain =parseJWT((Cookies.get('token'))).email
  ...
  return (
    <div>
      ...
      <div className="p-6 lg:p-8 flex gap-6 flex-col">
        ...
        <Title size="sm">
          You have more than 15,000 registered users. The Customer Portal cannot display the users in this case.<br/>
          Please contact Customer Support for further assistance.<br/><br/> 
        <Button 
      ...
      {state === 'success' && assignedLicensesCount < 15000  &&(
        ...
        <div>
          <div className="flex justify-between">
            ...
            <div>
              <h3>Email domain - {email_domain}</h3>
            </div> 
          <div className="mt-8">
            {!!listAllUsers && (
              <Tabel
      ...
      <div >
        ...
        <br/>
          <div style={{marginLeft:'40%'}}>
              <Title size="xs">This may take a few minutes</Title>
          </div>
      </div>
      )}
    </div>
